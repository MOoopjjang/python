...
def getOption():
	...
	parser.add_option('-p' , '--proxy' , action = 'store_true' , help = 'Proxy connection...' , default = False)
...
def main():
	...
	# RUN
	crawler = mcrawler.MCrawler(d['urls'] , d['dirs'] , getMPOption() , getZipOption(),getMaxDepth() , getProxyOption())
	crawler.run()
